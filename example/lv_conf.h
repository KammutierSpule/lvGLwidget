...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  <lvGLwidget/lvgl_wrap.h>       /*Header for the sys time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (LVGLWrap_GetMillis())     /*Expression evaluating to current systime in ms*/
